...
**Current Version:** v0.17.0 (released 2026-06-10)  
**Next Release:** v0.18.0  
**Status:** 29 components published to NPM; 2,101 tests passing
...
- [x] Vitest + React Testing Library (2,101 tests)
